    ...
    <div className="flex h-screen overflow-hidden bg-surface-container-low">
      ...
      <div className="flex-1 overflow-y-auto p-8">
        <div className="mx-auto w-full max-w-[1054px]">
          ...
          <div className="mt-6 flex items-center justify-between rounded-lg bg-surface p-6 shadow-[0px_1px_8px_0px_#00000026]">
          ...
          <div className="mt-2 flex flex-col gap-2 rounded-2xl bg-surface p-6 shadow-[0px_1px_8px_0px_#0000001A]">
